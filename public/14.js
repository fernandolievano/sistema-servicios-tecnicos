...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    IndexEquipos: function IndexEquipos() {
      return __webpack_require__.e(/*! import() */ 15).then(__webpack_require__.bind(null, /*! ./EquiposIndex.vue */ "./resources/js/components/views/equipos/EquiposIndex.vue"));
    }
  },
  data: function data() {
    return {
  ...
  mounted: function mounted() {
    this.$store.dispatch('equipo/fetchAll');
  }
});
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _c(
            "v-tab-item",
            [_c("index-equipos", { attrs: { section: "En Reparación" } })],
            1
          ),
          _vm._v(" "),
          _c(
            "v-tab-item",
            [_c("index-equipos", { attrs: { section: "Reparado" } })],
            1
          ),
          _vm._v(" "),
          _c(
            "v-tab-item",
            [_c("index-equipos", { attrs: { section: "Despachado" } })],
            1
          )
        ],
        1
